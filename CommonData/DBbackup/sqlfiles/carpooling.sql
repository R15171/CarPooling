...
CREATE TABLE `driver` (
  ...
  CONSTRAINT `driver_ibfk_1` FOREIGN KEY (`URID`) REFERENCES `userrole` (`URID`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `before_driver_insert` BEFORE INSERT ON `driver` FOR EACH ROW BEGIN
    ...
    -- Fetch the Date of Birth (DOB) from the User table using the URID foreign key
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `before_ride_insert_status` BEFORE INSERT ON `ride` FOR EACH ROW BEGIN
    ...
    ELSE
        ...
        IF driver_status = 'verified' THEN
...
CREATE TABLE `userrole` (
  ...
  PRIMARY KEY (`URID`),
  KEY `UID` (`UID`),
  CONSTRAINT `userrole_ibfk_2` FOREIGN KEY (`UID`) REFERENCES `user` (`UID`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-01-02 14:32:22
